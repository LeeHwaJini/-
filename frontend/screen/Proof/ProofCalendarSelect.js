...
const ProofCalendarSelect = ({ navigation }) => {
  ...
  const dayGrroup = ['당일', '1주일', '1개월', '3개월'];
        ...
        <View style={styles.content}>
          <View style={styles.quickSelectContainer}>
            ...
            >
              ...
              <EumcText style={[styles.rangeText, calData.start.date && calData.end.date ? styles.colorWhite : null]}>
                -
              </EumcText>
              <Pressable
                onPress={() => {
                  ...
                  setDateRange({ [calData.start.date]: { ...defaultCalendarStyle, startingDay: true } });
                }}
              >
                <EumcText
                  style={[
      ...
      <View style={styles.containerNext}>
        {calData.start.date && calData.end.date ? (
          <BottomTwoBtn
            ...
            rightTitle="조회"
            onNext={() => {
              if (calData.start.date && calData.end.date) navigation.navigate('ProofSelect', { calData });
              else setToast({ type: 'error', text1: '필수 선택', text2: '시작일과 종료일을 선택해 주세요.' });
            }}
...
export default ProofCalendarSelect;
